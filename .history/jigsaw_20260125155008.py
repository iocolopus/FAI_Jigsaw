...
class Backtrack_solver():
    ...
    def solve(self, plot_for_ipynb_t_1=False, plot_for_ipynb_t_2=False, plot_for_ipynb_t_3=False):
        ...
        def r_solve(current_solution):
            ...
            def plot_t_3():
                """
                Plot usando imágenes frontales (front).
                Las imágenes front están flipeadas horizontalmente respecto a back.
                Flipeamos FRONT para que coincida con BACK, así las esquinas ya detectadas son válidas.
                """
