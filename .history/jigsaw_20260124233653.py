...
class Edge():
    ...
    def resample_contour_uniform(self, n_samples=20, plot=False):
        """
        ...
        spline_x = CubicSpline(arc_lengths, x_orig, bc_type='natural')
        spline_y = CubicSpline(arc_lengths, y_orig, bc_type='natural')
        ...
        if plot:
            ...
            plt.plot(x_resampled, y_resampled, 'o', label='Remuestreado', color='orange')
            plt.axis('equal')
            plt.legend()
            plt.show()
    ...
    def dissimilarity(self, other, show=False):
        pass
