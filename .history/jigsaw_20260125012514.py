            ...
            if len(current_solution) < 15:
                ...
                for pieza_index, pieza in enumerate(self.pieces):
                    ...
                    for rot in range(4):
                        ...
                        # Buscamos la arista que debe coincidir con la arista ya colocada
                        placed_piece_index, placed_rot = current_solution[-1]
                        placed_piece = self.pieces[placed_piece_index]
                        placed_edge = placed_piece.edges[(placed_rot + second_edge_id) % 4]

                        dissim = edge.dissimilarity(placed_edge, c1=0.1, n_samples=50, plot=False)

                        pares_pieza_arista_candidatos.append( (dissim, (pieza_index, rot)) )
