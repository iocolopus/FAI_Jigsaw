    ...
    def solve(self):
        ...
        def r_solve(current_solution):
            ...
            if len(current_solution) < 15:
                ...
                def dissimilarity_key(id_pieza, rot):
                    return self.pieces[id_pieza].edges[rot].dissimilarity(
                        current_solution[-1][0].pieces[current_solution[-1][0]].edges[current_solution[-1][1]]
